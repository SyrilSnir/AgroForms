...
return [
    ...
    ['id' => ElementType::ELEMENT_SELECT_MULTIPLE, 'name' => 'Селектор с множественным мыбором'],
    ...
    ['id' => ElementType::ELEMENT_FILE, 'name' => 'Файл'],
    ['id' => ElementType::ELEMENT_FILE_MULTIPLE, 'name' => 'Несколько файлов'],
